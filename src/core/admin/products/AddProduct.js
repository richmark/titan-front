...
const AddProduct = () => {
                ...
                <div className="col-md-6 col-sm-6 col-xl-6 mb-4">
                    <div className="card border-left-primary shadow h-100 py-2">
                        <div className="card-body">
                            <input onChange={handleChange('product_name')} type="text" className="form-control bg-light small mb-2" placeholder="Product Name" />
                            <input onChange={handleChange('price')} type="text" className="form-control bg-light small mb-2" placeholder="Price" />
                            <input onChange={handleChange('stock')} type="text" className="form-control bg-light small mb-2" placeholder="Stock" />
                            <select onChange={handleChange('category')} id="category" className="btn btn-light w-100 border mb-2">
                            ...
                            <textarea onChange={handleChange('description')} className="form-control mb-2" id="exampleFormControlTextarea1" rows={3} placeholder="Description" defaultValue={""} />
                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="col-md-6 col-sm-6">
                                    <img src={image && image || "https://ctt.trains.com/sitefiles/images/no-preview-available.png"} style={{ width: '18vw', height: '30vh' }} />
                                </div>
    ...
    const showSave = () => {
        return (
            <Fragment>
                <button onClick={submitProduct} className="btn btn-primary" style={{ marginBottom: '15px', marginLeft: '15px'}}>Save</button>
            </Fragment>
        );
    };
